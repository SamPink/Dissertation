...
\begin{document}
    ...
    \begin{titlepage}      
        \begin{center}
            ...
            \linespread{1.2}\huge {Computer Science Undergraduate Report Template and Report Writing Guide}
            ...
            %------------------------------  Your Name  -------------------------------%
            % chnage the following line
            {\Large Firstname(s) Lastname}\\[1cm] 
